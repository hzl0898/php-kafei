...
<div class="main-content">
	<div class="container">
		...
		<div class="grid">
			<?php
				$sql=mysqli_query($conn,"select * from shangpin where tuijian=1 order by id desc limit 0,3");
...
<div class="main-content margin-2">
	<div class="container">
		...
		<div class="grid">
			<?php
				$sql=mysqli_query($conn,"select * from shangpin order by addtime desc limit 0,6");
				while($row=mysqli_fetch_array($sql))
				{
			?>
			<div class="col-md-4 m-b">
